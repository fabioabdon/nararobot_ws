...
#include "nara_msgs/Velocities.h"
//header file for cmd_subscribing to "cmd_vel"
#include "geometry_msgs/Twist.h"
//header file for pid server
#include "nara_msgs/PID.h"
//header file for imu
#include "nara_msgs/Imu.h"

#include "nara_base_config.h"
#include "Motor.h"
...
Kinematics kinematics(Kinematics::NARA_BASE, MAX_RPM, WHEEL_DIAMETER, FR_WHEELS_DISTANCE, LR_WHEELS_DISTANCE);
...
void PIDCallback(const nara_msgs::PID& pid);

ros::NodeHandle nh;

ros::Subscriber<geometry_msgs::Twist> cmd_sub("cmd_vel", commandCallback);
ros::Subscriber<nara_msgs::PID> pid_sub("pid", PIDCallback);

nara_msgs::Imu raw_imu_msg;
ros::Publisher raw_imu_pub("raw_imu", &raw_imu_msg);

nara_msgs::Velocities raw_vel_msg;
...
void PIDCallback(const nara_msgs::PID& pid)
{
    //callback function every time PID constants are received from nara_pid for tuning
